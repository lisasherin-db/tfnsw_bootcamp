...
checkpoint_location = f"/tmp/checkpoints/{silver_table_name}"
...
silver_df.writeStream.option("mergeSchema", "true").option("checkpointLocation", checkpoint_location).table(f"{catalog_name}.{database_name}.{silver_table_name}")
